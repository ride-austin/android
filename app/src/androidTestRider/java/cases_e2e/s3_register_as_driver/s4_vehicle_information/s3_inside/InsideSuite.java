package cases_e2e.s3_register_as_driver.s4_vehicle_information.s3_inside;
...
public class InsideSuite extends BaseE2ETest {
    @Rule
    ...
    @Test
    @TestCases("C1274573")
    public void shouldRequestHelpFromVehicleInside() throws IOException {
