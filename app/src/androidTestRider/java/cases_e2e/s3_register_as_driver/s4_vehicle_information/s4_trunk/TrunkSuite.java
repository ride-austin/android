package cases_e2e.s3_register_as_driver.s4_vehicle_information.s4_trunk;
...
public class TrunkSuite extends BaseE2ETest {
    ...
    @Test
    @TestCases("C1274574")
    public void shouldRequestHelpFromVehicleTrunk() throws IOException {
        ...
        RegisterAsDriverUtils.throughInsidePhoto(true);
