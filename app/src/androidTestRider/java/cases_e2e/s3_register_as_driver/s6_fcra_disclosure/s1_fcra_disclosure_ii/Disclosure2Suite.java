package cases_e2e.s3_register_as_driver.s6_fcra_disclosure.s1_fcra_disclosure_ii;
...
public class Disclosure2Suite extends BaseE2ETest {
    ...
    @Test
    @TestCases({"C1274296", "C1274297"})
    public void shouldRequestHelpFromDisclosure2() throws IOException {
        ...
        String paragraph = getString(R.string.the_fcra_background_check_investigation_first_paragraph, "Austin");
        onView(withId(R.id.firstParagraph)).check(matches(withText(paragraph)));
