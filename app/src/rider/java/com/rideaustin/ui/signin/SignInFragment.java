...
import com.rideaustin.ui.signup.CreateAccountActivity;
...
public class SignInFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        binding.done.setOnClickListener(v -> onLoginClicked());
    ...
    private void onForgotPasswordClicked() {
        ...
        intent.putExtra(Constants.USER_EMAIL_KEY, binding.email.getText().toString());
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        // and perform this check as well
    ...
    private void facebookUserNotAssociated() {
        ...
        String userNotAssociatedMessage = App.getInstance().getString(R.string.facebook_error, applicationName);
        intent.putExtra(CreateAccountActivity.EXTRA_MESSAGE_KEY, userNotAssociatedMessage);
        startActivity(intent);
        getActivity().finish();
    }
