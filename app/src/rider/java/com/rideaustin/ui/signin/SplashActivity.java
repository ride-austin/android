...
public class SplashActivity extends BaseActivity implements SplashView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.signUp.setOnClickListener(view -> startActivity(new Intent(SplashActivity.this, CreateAccountActivity.class)));
    ...
    public void onStart() {
        ...
        if (processStartupError()) {
            // something on start was wrong
    ...
    public void onGlobalConfigUpdate(final GlobalConfig globalConfig, boolean shouldFadeIn) {
        if (backgroundUrl == null || !backgroundUrl.equals(globalConfig.getGeneralInformation().getSplashUrl())) {
            ...
            if (backgroundTarget != null) {
                ImageHelper.clear(binding.mainContainer);
            }
        ...
        if (logoUrl == null || !logoUrl.equals(globalConfig.getGeneralInformation().getLogoUrl())) {
            ...
            if (logoTarget != null) {
                ImageHelper.clear(binding.logo);
            }
    ...
    private boolean processStartupError() {
        StartupError error = App.getDataManager().getStartupError();
        if (error == null) {
            return false;
        }
        switch (error) {
        ...
        App.getDataManager().setStartupError(null);
        return true;
    }
}
